            ...
            <div class="modal fade" id="addnew" tabindex="-1" role="dialog" aria-labelledby="addnew"
                ...
                <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <form action="{{ Route('admin.latest.add') }}" id="frmnewvalue" novalidate method="POST"
...
<br>
            ...
            <label>Arabic Name</label>
                                <input type="text" name="arabic_title" id="arabic_name" class="form-control" required>
                                <div class="invalid-feedback">
                                    Please enter a name
            </div>
            </br>
                            ...
                            <div class="modal fade" id="edt{{ $value->id }}" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ Route('admin.latest.update', $value->id) }}"
...
<br>
                                               ...
                                               Required
                                                ...
                                                <label>Arabic Name</label>
                                                <input type="text" name="arabic_title" id="arabic_name" class="form-control"
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="{{ Route('admin.latest.delete', $value->id) }}"
