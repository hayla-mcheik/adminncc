    ...
    <div class="card card-default">
        ...
        <div class="card-body" style="display: block;">
            ...
            <div class="modal fade" id="addnew" tabindex="-1" role="dialog" aria-labelledby="addnew"
                ...
                <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <form action="{{ Route('admin.subsidiaries.add') }}" id="frmnewvalue" novalidate method="POST"
            ...
            <label>Arabic Slug</label>
                                <input type="text" name="arabic_slug" id="arabic_slug" class="form-control" required>
                                <div class="invalid-feedback">
                                    Please enter a slug
            </div>
            </br>
                            ...
                            <div class="modal fade" id="edt{{ $value->id }}" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ Route('admin.subsidiaries.update', $value->id) }}"
                                            ...
                                            <div class="modal-body">
                                             ...
                                             <br>
                                               ...
                                               Required
                                                ...
                                                <label>Arabic Slug</label>
                                                <input type="text" name="arabic_slug" id="arabic_slug" class="form-control"
                                                    value="{{ $value->arabic_slug }}" required>
                                                <div class="invalid-feedback">
                                               Required
                                                </div>
                                                <br>
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="{{ Route('admin.subsidiaries.delete', $value->id) }}"
