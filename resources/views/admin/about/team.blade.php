            ...
            <div class="modal fade" id="addnew" tabindex="-1" role="dialog" aria-labelledby="addnew"
                ...
                <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <form action="{{ Route('admin.about.team.add') }}" id="frmnewvalue" novalidate method="POST"
                            ...
                            <div class="modal fade" id="edt{{ $value->id }}" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ Route('admin.about.team.update', $value->id) }}"
                                            ...
                                            <label>Arabic Description</label>
                                            <textarea type="text" name="arabic_description"  id="arabic_description{{ $value->id }}" class="form-control" required>{{ $value->description }}</textarea>
                                            <div class="invalid-feedback">
                                                Please enter a description.
                                            </div>
                                            <script>
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="{{ Route('admin.about.team.delete', $value->id) }}"
